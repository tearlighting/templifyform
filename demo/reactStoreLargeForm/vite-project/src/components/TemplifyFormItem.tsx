...
import { useTemplifyFieldSubscription } from "@/hooks/useTemplifyFieldSubscription"
    ...
    >
      <div style={{ display: "flex" }}>
        <div style={{ flex: 1 }}>
          ...
          {item.type === ETemplateType.date && <DatePicker size="large" defaultValue={dayjs(value)} onChange={(_, e) => setField(item.prop, e)} className={item.formItemContentClassName} />}
