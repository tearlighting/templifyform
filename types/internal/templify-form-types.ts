...
import { ResolvableValue } from '#/core';
import type {
    z,
    ZodObject,
    ZodString,
...
export type TErrorMap<TKey extends string, TValue extends string = string> =
    Partial<Record<TKey, Partial<Record<keyof ZodString, TValue>>>>